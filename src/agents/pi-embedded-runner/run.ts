...
import { ensureOPENAEONModelsJson } from "../models-config.js";
import {
...
const toNormalizedUsage = (usage: UsageAccumulator) => {
  ...
  // See: https://github.com/openaeon/openaeon/issues/13698
  //
...
export async function runEmbeddedPiAgent(
  ...
  return enqueueSession(() =>
    enqueueGlobal(async () => {
      ...
      await ensureOPENAEONModelsJson(params.config, agentDir);
