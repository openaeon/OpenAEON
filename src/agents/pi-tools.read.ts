...
function resolveAdaptiveReadMaxBytes(options?: OPENAEONReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOPENAEONReadTool(base, {
...
export function createOPENAEONReadTool(
  base: AnyAgentTool,
  options?: OPENAEONReadToolOptions,
): AnyAgentTool {
