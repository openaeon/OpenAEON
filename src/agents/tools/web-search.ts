...
type WebSearchConfig = NonNullable<OPENAEONConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: OPENAEONConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("openaeon configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.openaeon.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://openaeon.ai",
          "X-Title": "OPENAEON Web Search",
        },
