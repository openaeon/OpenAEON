...
const CLEANUP_STATE_KEY = Symbol.for("openaeon.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("openaeon.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("openaeon.sessionWriteLockWatchdogState");
