...
type AgentEntry = NonNullable<NonNullable<OPENAEONConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: OPENAEONConfig): AgentEntry[] {
...
export function listAgentIds(cfg: OPENAEONConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OPENAEONConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: OPENAEONConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: OPENAEONConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OPENAEONConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: OPENAEONConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
