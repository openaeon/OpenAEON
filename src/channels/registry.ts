...
const WEBSITE_URL = "https://openaeon.ai";
...
const CHAT_CHANNEL_META: Record<ChatChannelId, ChannelMeta> = {
  ...
  webchat: {
    id: "webchat",
    label: "Webchat",
    selectionLabel: "Webchat (Browser Client)",
    detailLabel: "Webchat",
    docsPath: "/channels/webchat",
    docsLabel: "webchat",
    blurb: "built-in web interface for direct interaction.",
    systemImage: "window.badge.message",
  },
};
