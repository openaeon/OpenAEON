...
function resolveResolutionLimits(config: OPENAEONConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OPENAEONConfig): SecretProviderConfig {
