...
export type OPENAEONPluginConfigSchema = {
...
export type OPENAEONPluginToolContext = {
...
export type OPENAEONPluginToolFactory = (
  ctx: OPENAEONPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OPENAEONPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OPENAEONPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OPENAEONConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OPENAEONPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current OPENAEON configuration */
  config: OPENAEONConfig;
 ...
 */
export type OPENAEONPluginCommandDefinition = {
...
export type OPENAEONPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type OPENAEONPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type OPENAEONPluginCliContext = {
  program: Command;
  config: OPENAEONConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OPENAEONPluginCliRegistrar = (ctx: OPENAEONPluginCliContext) => void | Promise<void>;

export type OPENAEONPluginServiceContext = {
  config: OPENAEONConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OPENAEONPluginService = {
  id: string;
  start: (ctx: OPENAEONPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OPENAEONPluginServiceContext) => void | Promise<void>;
};

export type OPENAEONPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OPENAEONPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OPENAEONPluginConfigSchema;
  register?: (api: OPENAEONPluginApi) => void | Promise<void>;
  activate?: (api: OPENAEONPluginApi) => void | Promise<void>;
};

export type OPENAEONPluginModule =
  | OPENAEONPluginDefinition
  | ((api: OPENAEONPluginApi) => void | Promise<void>);

export type OPENAEONPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OPENAEONPluginToolFactory,
    opts?: OPENAEONPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OPENAEONPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: OPENAEONPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: OPENAEONPluginHttpRouteHandler }) => void;
  registerChannel: (registration: OPENAEONPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OPENAEONPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OPENAEONPluginService) => void;
   ...
   */
  registerCommand: (command: OPENAEONPluginCommandDefinition) => void;
