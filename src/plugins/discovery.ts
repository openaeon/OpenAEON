...
export type PluginCandidate = {
  ...
  packageDir?: string;
  packageManifest?: OPENAEONPackageManifest;
};
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openaeon/voice-call -> voice-call).
...
export function discoverOPENAEONPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openaeon", "extensions")];
