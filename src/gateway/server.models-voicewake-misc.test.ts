...
const expectedSortedCatalog = (): ModelCatalogRpcEntry[] => [
  ...
  {
    contextWindow: 64000,
    id: "deepseek-chat-expert-search",
    input: ["text"],
    name: "DeepSeek Expert Mode (Web + Search)",
  ...
  },
  {
    ...
    input: ["text"],
    name: "DeepSeek Expert Mode (Web)",
    provider: "deepseek-web",
    reasoning: false,
  },
  {
    contextWindow: 64000,
    id: "deepseek-reasoner-expert-search",
    input: ["text"],
    name: "DeepSeek Expert Mode + Deep Thinking (Web + Search)",
    provider: "deepseek-web",
    reasoning: true,
  },
  {
    ...
    input: ["text"],
    name: "DeepSeek Expert Mode + Deep Thinking (Web)",
    provider: "deepseek-web",
    reasoning: true,
  },
  {
    ...
    input: ["text", "image"],
    name: "DeepSeek Fast Mode (Web + Search)",
    provider: "deepseek-web",
    reasoning: false,
  },
  {
  ...
  },
  {
    ...
    input: ["text", "image"],
    name: "DeepSeek Fast Mode + Deep Thinking (Web + Search)",
    provider: "deepseek-web",
    reasoning: true,
  },
  {
    ...
    input: ["text", "image"],
    name: "DeepSeek Fast Mode + Deep Thinking (Web)",
    provider: "deepseek-web",
    reasoning: true,
  },
  {
    contextWindow: 64000,
    id: "deepseek-vision-search",
    input: ["text", "image"],
    name: "DeepSeek Vision Mode (Web + Search)",
    provider: "deepseek-web",
    reasoning: false,
  },
  {
    ...
    id: "deepseek-vision",
    input: ["text", "image"],
    name: "DeepSeek Vision Mode (Web)",
    provider: "deepseek-web",
    reasoning: false,
  },
  {
    contextWindow: 64000,
    id: "deepseek-reasoner-vision-search",
    input: ["text", "image"],
    name: "DeepSeek Vision Mode + Deep Thinking (Web + Search)",
    provider: "deepseek-web",
    reasoning: true,
  },
  {
    ...
    input: ["text", "image"],
    name: "DeepSeek Vision Mode + Deep Thinking (Web)",
    provider: "deepseek-web",
    reasoning: true,
  },
  {
...
describe("gateway server models + voicewake", () => {
  ...
  const withModelsConfig = async <T>(config: unknown, run: () => Promise<T>): Promise<T> => {
    const configPath = process.env.OPENAEON_CONFIG_PATH;
    if (!configPath) {
      throw new Error("Missing OPENAEON_CONFIG_PATH");
    }
...
describe("gateway server misc", () => {
  test("hello-ok advertises the gateway port for canvas host", async () => {
    await withEnvAsync({ OPENAEON_GATEWAY_TOKEN: "secret" }, async () => {
      testTailnetIPv4.value = "100.64.0.1";
      testState.gatewayBind = "lan";
      const canvasPort = await getFreePort();
      testState.canvasHostPort = canvasPort;
      await withEnvAsync({ OPENAEON_CANVAS_HOST_PORT: String(canvasPort) }, async () => {
