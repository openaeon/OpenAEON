...
export async function onTimer(state: CronServiceState) {
  if (state.running) {
    ...
    // execution to finish.
    // See: https://github.com/openaeon/openaeon/issues/12025
...
> {
    ...
    if (job.wakeMode === "now" && state.deps.runHeartbeatOnce) {
      ...
      for (;;) {
        ...
        heartbeatResult = await state.deps.runHeartbeatOnce({
          ...
          // See: https://github.com/openaeon/openaeon/issues/28508
  ...
  // See: https://github.com/openaeon/openaeon/issues/15692
