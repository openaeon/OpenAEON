...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.lanes": "Gateway Broadcast Lanes",
  "gateway.lanes.chat_lane": "Chat Lane Policy",
  "gateway.lanes.agent_lane": "Agent Lane Policy",
  "gateway.lanes.tool_lane": "Tool Lane Policy",
  "gateway.lanes.chat_lane.maxInFlight": "Chat Lane Max In-Flight",
  "gateway.lanes.chat_lane.queueLimit": "Chat Lane Queue Limit",
  "gateway.lanes.chat_lane.timeoutMs": "Chat Lane Timeout (ms)",
  "gateway.lanes.chat_lane.retryBudget": "Chat Lane Retry Budget",
  "gateway.lanes.chat_lane.dropIfSlow": "Chat Lane Drop If Slow",
  "gateway.lanes.agent_lane.maxInFlight": "Agent Lane Max In-Flight",
  "gateway.lanes.agent_lane.queueLimit": "Agent Lane Queue Limit",
  "gateway.lanes.agent_lane.timeoutMs": "Agent Lane Timeout (ms)",
  "gateway.lanes.agent_lane.retryBudget": "Agent Lane Retry Budget",
  "gateway.lanes.agent_lane.dropIfSlow": "Agent Lane Drop If Slow",
  "gateway.lanes.tool_lane.maxInFlight": "Tool Lane Max In-Flight",
  "gateway.lanes.tool_lane.queueLimit": "Tool Lane Queue Limit",
  "gateway.lanes.tool_lane.timeoutMs": "Tool Lane Timeout (ms)",
  "gateway.lanes.tool_lane.retryBudget": "Tool Lane Retry Budget",
  "gateway.lanes.tool_lane.dropIfSlow": "Tool Lane Drop If Slow",
  ...
  "tools.web.search.browserFallback.enabled": "Web Search Browser Fallback",
  "tools.web.search.browserFallback.engineUrl": "Web Search Browser Engine URL",
  "tools.web.search.browserFallback.timeoutSeconds": "Web Search Browser Timeout (sec)",
  "tools.web.search.browserFallback.autoStart": "Web Search Browser Auto-Start",
  ...
  "tools.web.privateNetwork": "Web Tools Private Network Policy",
  "tools.web.privateNetwork.allowlist": "Web Tools Private Network Allowlist",
  ...
  "ui.chat": "Chat UI",
  "ui.chat.performanceMode": "Chat Performance Mode",
  "ui.chat.subagentMatchMode": "Sub-agent Matching Strategy",
