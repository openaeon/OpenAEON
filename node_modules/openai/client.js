...
class OpenAI {
  ...
  constructor({
    ...
    organization = (0, env_1.readEnv)("OPENAI_ORG_ID") ?? null,
    project = (0, env_1.readEnv)("OPENAI_PROJECT_ID") ?? null,
    webhookSecret = (0, env_1.readEnv)("OPENAI_WEBHOOK_SECRET") ?? null,
    ...opts
  } = {}) {
    ...
    this.logLevel =
      ...
      (0, log_1.parseLogLevel)(
        (0, env_1.readEnv)("OPENAI_LOG"),
  ...
  buildURL(path, query, defaultBaseURL) {
    const baseURL =
      (!tslib_1
        .__classPrivateFieldGet(this, _OpenAI_instances, "m", _OpenAI_baseURLOverridden)
        .call(this) &&
        defaultBaseURL) ||
      this.baseURL;
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    (0, log_1.loggerFor)(this).debug(
      `[${requestLogID}] sending request`,
      (0, log_1.formatRequestDetails)({
        retryOfRequestLogID,
  ...
  buildBody({ options: { body, headers: rawHeaders } }) {
    ...
    if (
      ...
      return tslib_1
        .__classPrivateFieldGet(this, _OpenAI_encoder, "f")
        .call(this, { body, headers });
    }
  }
}
exports.OpenAI = OpenAI;
((_a = OpenAI),
  (_OpenAI_encoder = new WeakMap()),
  (_OpenAI_instances = new WeakSet()),
  (_OpenAI_baseURLOverridden = function _OpenAI_baseURLOverridden() {
