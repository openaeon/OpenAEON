...
let DateTimeInput = (() => {
  ...
  var DateTimeInput = class extends _classSuper {
    ...
    set label(value) {
      ...
      __runInitializers(this, _enableDate_initializers, true));
    get enableDate() {
    ...
    set enableDate(value) {
      ...
      (__runInitializers(this, _enableDate_extraInitializers),
      __runInitializers(this, _enableTime_initializers, true));
    get enableTime() {
