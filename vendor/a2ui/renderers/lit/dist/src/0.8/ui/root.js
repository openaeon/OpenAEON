...
let Root = (() => {
  ...
  var Root = class extends _classSuper {
    ...
    #surfaceId_accessor_storage =
      ...
      __runInitializers(this, _surfaceId_initializers, null));
    get surfaceId() {
    ...
    #component_accessor_storage =
      (__runInitializers(this, _surfaceId_extraInitializers),
      __runInitializers(this, _component_initializers, null));
    get component() {
    ...
    #theme_accessor_storage =
      (__runInitializers(this, _component_extraInitializers),
      __runInitializers(this, _theme_initializers, void 0));
    get theme() {
    ...
    #childComponents_accessor_storage =
      ...
      __runInitializers(this, _childComponents_initializers, null));
    get childComponents() {
    ...
    #processor_accessor_storage =
      (__runInitializers(this, _childComponents_extraInitializers),
      __runInitializers(this, _processor_initializers, null));
    get processor() {
    ...
    #dataContextPath_accessor_storage =
      ...
      __runInitializers(this, _dataContextPath_initializers, ""));
    get dataContextPath() {
    ...
    set dataContextPath(value) {
      ...
      (__runInitializers(this, _dataContextPath_extraInitializers),
      __runInitializers(this, _enableCustomElements_initializers, false));
