...
let Slider = (() => {
  ...
  var Slider = class extends _classSuper {
    ...
    #minValue_accessor_storage =
      ...
      __runInitializers(this, _minValue_initializers, 0));
    get minValue() {
    ...
    #maxValue_accessor_storage =
      (__runInitializers(this, _minValue_extraInitializers),
      __runInitializers(this, _maxValue_initializers, 0));
    get maxValue() {
    ...
    #label_accessor_storage =
      ...
      __runInitializers(this, _label_initializers, null));
    get label() {
    ...
    #inputType_accessor_storage =
      ...
      __runInitializers(this, _inputType_initializers, null));
    get inputType() {
