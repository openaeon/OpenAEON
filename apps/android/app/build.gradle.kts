...
android {
    namespace = "ai.openaeon.android"
    compileSdk = 36

    sourceSets {
        getByName("main") {
            assets.directories.add("../../shared/OpenAEONKit/Sources/OpenAEONKit/Resources")
        }
    }
    ...
    onVariants { variant ->
        variant.outputs
            ...
            .forEach { output ->
                ...
                val outputFileName = "openaeon-$versionName-$buildType.apk"
...
dependencies {
    val composeBom = platform("androidx.compose:compose-bom:2026.5.19")
