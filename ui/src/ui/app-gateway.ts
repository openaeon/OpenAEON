...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "openaeon-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as OPENAEONApp);
      void loadAgents(host as unknown as OPENAEONApp);
      void loadToolsCatalog(host as unknown as OPENAEONApp);
      void loadNodes(host as unknown as OPENAEONApp, { quiet: true });
      void loadDevices(host as unknown as OPENAEONApp, { quiet: true });
