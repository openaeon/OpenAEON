...
description: Extract text from PDFs and scanned documents. Use web_fetch for remote URLs, pymupdf for local text-based PDFs, marker-pdf for OCR/scanned docs. For DOCX use python-docx, for PPTX see the powerpoint skill.
version: 2.3.0
author: OPENAEON
license: MIT
metadata:
