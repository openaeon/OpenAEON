---
name: peekaboo
description: "Capture and automate macOS UI with the Peekaboo CLI. General desktop automation: screenshots, UI maps, app/window control, UIAX vs synthetic input, typing, menus, clipboard, permissions, MCP, and local validation."
