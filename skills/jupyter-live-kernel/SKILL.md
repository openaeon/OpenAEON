...
description: >
  ...
  building up complex code step-by-step. Uses exec to run CLI commands against
...
across executions. Use this instead of one-shot code execution when you need to build up
...
| one-shot code execution | One-shot scripts needing OpenAEON runtime tool access (web_search, file ops). Stateless. |
